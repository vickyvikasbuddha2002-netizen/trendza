...
export const CATEGORIES: Category[] = [
  {
    ...
    picks: [
      ...
      link("https://link.amazon/B0fskhg8W"),
      link("https://link.amazon/B057qft0O"),
      link("https://link.amazon/B02o1K2TC"),
      link("https://link.amazon/B012G9Eq9"),
      link("https://link.amazon/B07V7rJKb"),
      link("https://link.amazon/B06quzxjk"),
      link("https://link.amazon/B04nDO0Uk"),
      link("https://link.amazon/B08vlrCfj"),
      link("https://link.amazon/B0iD9H9q5"),
      link("https://link.amazon/B0dKkS272"),
    ],
  },
  {
    id: "watches-him",
    ...
    blurb:
      "The gift that gets worn every day and quietly reminds him where it came from. Hard to get wrong, hard to forget.",
    motif: "silver",
    audience: "him",
    shipDays: 4,
    picks: [
      link("https://link.amazon/B02b13Dk4"),
      link("https://link.amazon/B0i3QciET"),
      link("https://link.amazon/B01e6xcYJ"),
    ],
  },
  {
    id: "watches-her",
    ...
    blurb:
      "Something on the wrist beside the rakhi. Worn long after the thread has come off, which is rather the idea.",
    motif: "silver",
    audience: "her",
    shipDays: 4,
    picks: [
      link("https://link.amazon/B0bYDJzTU"),
      link("https://link.amazon/B04YUW3MX"),
      link("https://link.amazon/B0apSglx7"),
      link("https://link.amazon/B0fX4oK73"),
    ],
  },
  {
    id: "hampers",
