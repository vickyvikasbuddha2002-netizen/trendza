...
-- ── Counter ───────────────────────────────────────────────────────
-- No new column, and nothing to migrate. The landing page counts lists
-- straight from this table via wishlist_stats() below, which cannot drift
-- out of step with reality the way a separate counter can — and which
